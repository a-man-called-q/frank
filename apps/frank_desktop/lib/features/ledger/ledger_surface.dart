            ...
            child: SizedBox(
              ...
              child: data.trend.isEmpty
                  ...
                  : CustomPaint(
                      ...
                      painter: _LedgerTrendPainter(data.trend),
                    ),
            ),
          ),
        ],
...
class _LedgerTrendPainter extends CustomPainter {
  _LedgerTrendPainter(this.points);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var tick = 0; tick <= 3; tick++) {
      ...
      _paintText(
        canvas,
        _formatCompactCount(value.round()),
...
String _formatRange(TokenRange? range) {
  ...
  return '${_formatCompactCount(range.low)}–${_formatCompactCount(range.high)}';
}
