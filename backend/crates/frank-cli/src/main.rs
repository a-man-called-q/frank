...
#[derive(Subcommand)]
enum ServerCommand {
    /// Issue a short-lived, single-use pairing ticket.
    Pair {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long, default_value = "owner")]
        role: String,
        #[arg(long, default_value = "Frank device")]
        device_name: String,
        /// Development-only loopback HTTP fallback. Never valid for LAN/VPN.
        #[arg(long)]
        insecure_local: bool,
        /// Emit the complete ticket as machine-readable JSON.
        #[arg(long)]
        json: bool,
    },
    ...
    Health {
        ...
        #[arg(long)]
        insecure_local: bool,
        /// Emit machine-readable JSON (the default is already JSON for
        /// backwards compatibility; this flag makes scripts self-documenting).
        #[arg(long)]
        json: bool,
    },
    /// Run the owner-only runtime/database/provider diagnostic bundle.
    Doctor {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long)]
    ...
    /// Fetch the authoritative server snapshot.
    Snapshot {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long)]
    ...
    /// Fetch the server capability and protocol handshake document.
    Capabilities {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long)]
    ...
    /// List paired devices (owner role required).
    Devices {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long)]
    ...
    /// Print server settings from the current snapshot.
    Settings {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long)]
    ...
    /// List persistent agent profiles.
    Agents {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long)]
    ...
    /// List measured/estimated usage entries without combining them.
    Ledger {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long)]
    ...
    /// List durable daemon operations and their recovery phases.
    Operations {
        #[arg(long, default_value = "https://127.0.0.1:37465")]
        address: String,
        #[arg(long)]
    ...
    /// Run the runtime doctor (alias for `server doctor`).
    ...
    /// Check or apply a signed Frank update. Mutations remain owner-only.
    Update {
        #[command(subcommand)]
        command: UpdateCommand,
    },
    /// Render and install the per-user frankd service descriptor.
    InstallService {
        #[arg(long)]
        ...
        bind: String,
        /// Render the descriptor without writing or activating the service.
        #[arg(long)]
        preview: bool,
    },
    /// Show per-user frankd service status.
    #[command(name = "status", alias = "service-status")]
    ServiceStatus,
    /// Show recent frankd service logs.
    #[command(name = "logs", alias = "service-logs")]
    ServiceLogs,
    /// Restart the installed per-user frankd service.
    #[command(name = "restart", alias = "service-restart")]
    ServiceRestart,
    /// Stop, disable, and remove the installed per-user frankd service.
...
fn run() -> i32 {
    ...
    match cli.command {
        ...
        Command::Server { command } => server_cmd::run(server_cmd::ServerArgs {
            command: match command {
                ServerCommand::Pair {
                    ...
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Pair {
                    address,
                    role,
                    device_name,
                    insecure_local,
                ...
                ServerCommand::Health {
                    ...
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Health {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Doctor {
                    ...
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Doctor {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Snapshot {
                    ...
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Snapshot {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Capabilities {
                    ...
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Capabilities {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Devices {
                    address,
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Devices {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Settings {
                    address,
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Settings {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Projects {
                    address,
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Projects {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Agents {
                    address,
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Agents {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Missions {
                    ...
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Missions {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Tasks {
                    ...
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Tasks {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Approvals {
                    address,
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Approvals {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Artifacts {
                    ...
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Artifacts {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Ledger {
                    address,
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Ledger {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Operations {
                    address,
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::Operations {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::RuntimeDoctor {
                    address,
                    insecure_local,
                    json,
                } => server_cmd::ServerSubcommand::RuntimeDoctor {
                    address,
                    insecure_local,
                    json,
                },
                ServerCommand::Update { command } => match command {
                    UpdateCommand::Check {
                        address,
                        insecure_local,
                        json,
                    } => server_cmd::ServerSubcommand::UpdateCheck {
                        address,
                        insecure_local,
                        json,
                    },
                    UpdateCommand::Prepare {
                        ...
                        insecure_local,
                        json,
                    } => server_cmd::ServerSubcommand::UpdatePrepare {
                        version,
                        address,
                        insecure_local,
                        json,
                    ...
                    UpdateCommand::Apply {
                        ...
                        insecure_local,
                        json,
                    } => server_cmd::ServerSubcommand::UpdateApply {
                        update_id,
                        address,
                        insecure_local,
                        json,
                    ...
                    UpdateCommand::Rollback {
                        ...
                        insecure_local,
                        json,
                    } => server_cmd::ServerSubcommand::UpdateRollback {
                        address,
                        insecure_local,
                        json,
                    },
                ...
                ServerCommand::InstallService {
                    ...
                    bind,
                    preview,
                } => server_cmd::ServerSubcommand::InstallService {
                    output,
                    executable,
                    database,
                    bind,
                ...
                ServerCommand::ServiceStatus => server_cmd::ServerSubcommand::ServiceStatus,
                ServerCommand::ServiceLogs => server_cmd::ServerSubcommand::ServiceLogs,
                ServerCommand::ServiceRestart => server_cmd::ServerSubcommand::ServiceRestart,
                ServerCommand::UninstallService => server_cmd::ServerSubcommand::UninstallService,
            },
        }),
    }
}
