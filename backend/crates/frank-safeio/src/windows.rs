...
//! **not yet exercised on real Windows** — this workstation is macOS. Native
//! Windows validation remains a release gate, but the implementation keeps
//! the same symlink, size, and ownership contract as the Unix backend.
//!
